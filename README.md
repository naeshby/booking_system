# Glamour Shots — Smart Appointment & Lead Management

A minimal, fully functional appointment booking and lead management system built with React (Vite) + Tailwind CSS on the frontend and Node.js + Express on the backend, with Supabase (PostgreSQL) as the database.
...
6. Add environment variables:
   ...
   - `FRONTEND_URL` = your Vercel frontend URL (e.g. `https://glamourshots.vercel.app`)
7. Copy the Render service URL (e.g. `https://glamourshots-api.onrender.com`).
...
- Update `https://glamourshots.vercel.app` in `sitemap.xml` and `robots.txt` with your real domain.
